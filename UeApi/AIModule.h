...
public:
    ...
    EPathFollowingRequestResult MoveToLocation(FVector Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath);
...
public:
    ...
    void SetValueAsClass(FName KeyName, class UClass* ClassValue);
    ...
    void SetValueAsObject(FName KeyName, class UObject* ObjectValue);
    ...
    UE_PURE bool GetValueAsBool(FName KeyName) const;
    UE_PURE class UClass* GetValueAsClass(FName KeyName) const;
    UE_PURE uint8 GetValueAsEnum(FName KeyName) const;
    UE_PURE float GetValueAsFloat(FName KeyName) const;
    UE_PURE int GetValueAsInt(FName KeyName) const;
    UE_PURE FName GetValueAsName(FName KeyName) const;
    UE_PURE class UObject* GetValueAsObject(FName KeyName) const;
    UE_PURE FRotator GetValueAsRotator(FName KeyName) const;
    UE_PURE FString GetValueAsString(FName KeyName) const;
    UE_PURE FVector GetValueAsVector(FName KeyName) const;
    UE_PURE bool IsVectorValueSet(FName KeyName) const;
};
...
public:
    ...
    static void SimpleMoveToLocation(class AController* Controller, FVector Goal);
...
public:
    ...
    static TSubclassOf<class UAISense> GetSenseClassForStimulus(class UObject* WorldContextObject, FAIStimulus Stimulus);
    static TSubclassOf<class UAISense> GetSenseClassForStimulus(FAIStimulus Stimulus);
...
public:
    ...
    static void ClearBlackboardValue(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    static void ClearBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static class AActor* GetBlackboardValueAsActor(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static bool GetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static class UClass* GetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static uint8 GetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static float GetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static int GetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static FName GetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static class UObject* GetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static FRotator GetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static FString GetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    UE_PURE static FVector GetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector Key);
    ...
    static void SetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector Key, bool Value);
    static void SetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector Key, class UClass* Value);
    static void SetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector Key, uint8 Value);
    static void SetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector Key, float Value);
    static void SetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector Key, int Value);
    static void SetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector Key, FName Value);
    static void SetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector Key, class UObject* Value);
    static void SetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector Key, FRotator Value);
    static void SetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector Key, FString Value);
    static void SetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector Key, FVector Value);
...
public:
    ...
    void OnActorBump(class AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse, FHitResult Hit);
...
public:
    ...
    static int AddLocalNavigationGridForBox(class UObject* WorldContextObject, FVector Location, FVector Extent, FRotator Rotation, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForBox(FVector Location, FVector Extent, FRotator Rotation, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, FVector Location, float CapsuleRadius, float CapsuleHalfHeight, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForCapsule(FVector Location, float CapsuleRadius, float CapsuleHalfHeight, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForPoint(class UObject* WorldContextObject, FVector Location, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForPoint(FVector Location, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForPoints(class UObject* WorldContextObject, TArray<FVector> Locations, int Radius2D, float Height, bool bRebuildGrids);
    static int AddLocalNavigationGridForPoints(TArray<FVector> Locations, int Radius2D, float Height, bool bRebuildGrids);
    static bool FindLocalNavigationGridPath(class UObject* WorldContextObject, FVector Start, FVector End, TArray<FVector>& PathPoints);
    static bool FindLocalNavigationGridPath(FVector Start, FVector End, TArray<FVector>& PathPoints);
