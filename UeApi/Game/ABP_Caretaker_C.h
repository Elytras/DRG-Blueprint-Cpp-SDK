#pragma once
/*
Blueprint class ABP_Caretaker_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Caretaker_C : public UCaretagerBodyAnimInstance
{
public:
    UE_CLASS("/Game/GameElements/Objectives/Facility/Caretaker/ABP_Caretaker", "ABP_Caretaker_C");
    ...
    void ExecuteUbergraph_ABP_Caretaker(int EntryPoint);
...
using ABP_Caretaker_C = Game::GameElements::Objectives::Facility::Caretaker::ABP_Caretaker_C;