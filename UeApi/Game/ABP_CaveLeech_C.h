#pragma once
/*
Blueprint class ABP_CaveLeech_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_CaveLeech_C : public UCaveLeechAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/CaveLeech/ABP_CaveLeech", "ABP_CaveLeech_C");
    ...
    void ExecuteUbergraph_ABP_CaveLeech(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}   // namespace Game::Enemies::CaveLeech

using ABP_CaveLeech_C = Game::Enemies::CaveLeech::ABP_CaveLeech_C;