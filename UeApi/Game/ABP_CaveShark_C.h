#pragma once
/*
Blueprint class ABP_CaveShark_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
namespace Game { namespace Enemies { namespace Shark { namespace Animations {

class ABP_CaveShark_C : public USharkAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/Shark/Animations/ABP_CaveShark", "ABP_CaveShark_C");
    ...
    void ExecuteUbergraph_ABP_CaveShark(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}}   // namespace Game::Enemies::Shark::Animations

using ABP_CaveShark_C = Game::Enemies::Shark::Animations::ABP_CaveShark_C;