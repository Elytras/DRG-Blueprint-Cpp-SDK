#pragma once
/*
Blueprint class ABP_Coilgun_C_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
namespace Game { namespace WeaponsNTools { namespace CoilGun { namespace Animation {

class ABP_Coilgun_C_C : public UCoilGunAnimInstance
{
public:
    UE_CLASS("/Game/WeaponsNTools/CoilGun/Animation/ABP_Coilgun_C", "ABP_Coilgun_C_C");
    ...
    void ExecuteUbergraph_ABP_Coilgun_C(int EntryPoint);
...
}}}}   // namespace Game::WeaponsNTools::CoilGun::Animation

using ABP_Coilgun_C_C = Game::WeaponsNTools::CoilGun::Animation::ABP_Coilgun_C_C;