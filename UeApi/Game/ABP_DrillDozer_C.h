#pragma once
/*
Blueprint class ABP_DrillDozer_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_DrillDozer_C : public UEscortMuleAnimInstance
{
public:
    UE_CLASS("/Game/GameElements/Objectives/Escort/DrillDozer/ABP_DrillDozer", "ABP_DrillDozer_C");
    ...
    void ExecuteUbergraph_ABP_DrillDozer(int EntryPoint);
...
using ABP_DrillDozer_C = Game::GameElements::Objectives::Escort::DrillDozer::ABP_DrillDozer_C;