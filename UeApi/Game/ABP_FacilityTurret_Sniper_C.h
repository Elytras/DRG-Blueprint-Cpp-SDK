#pragma once
/*
Blueprint class ABP_FacilityTurret_Sniper_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_FacilityTurret_Sniper_C : public UFacilityTurretAnimInstance
{
public:
    UE_CLASS("/Game/GameElements/Objectives/Facility/DefenseTurret/Assets/ABP_FacilityTurret_Sniper", "ABP_FacilityTurret_Sniper_C");
    ...
    void ExecuteUbergraph_ABP_FacilityTurret_Sniper(int EntryPoint);
...
using ABP_FacilityTurret_Sniper_C = Game::GameElements::Objectives::Facility::DefenseTurret::Assets::ABP_FacilityTurret_Sniper_C;