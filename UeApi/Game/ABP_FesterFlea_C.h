#pragma once
/*
Blueprint class ABP_FesterFlea_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_FesterFlea_C : public USpiderAnimInstance
{
public:
    UE_CLASS("/Game/Critters/FesterFlea/ABP_FesterFlea", "ABP_FesterFlea_C");
    ...
    bool Flying;
    void ExecuteUbergraph_ABP_FesterFlea(int EntryPoint);
...
using ABP_FesterFlea_C = Game::Critters::FesterFlea::ABP_FesterFlea_C;