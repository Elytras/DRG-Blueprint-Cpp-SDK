#pragma once
/*
Blueprint class ABP_InfectedMuleTurret_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_InfectedMuleTurret_C : public UConvertedRobotTurretAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/MuleInfected/Animations/ABP_InfectedMuleTurret", "ABP_InfectedMuleTurret_C");
    ...
    void ExecuteUbergraph_ABP_InfectedMuleTurret(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}}   // namespace Game::Enemies::MuleInfected::Animations

using ABP_InfectedMuleTurret_C = Game::Enemies::MuleInfected::Animations::ABP_InfectedMuleTurret_C;