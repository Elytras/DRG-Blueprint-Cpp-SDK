#pragma once
/*
Blueprint class ABP_Minehead_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Minehead_C : public UAnimInstance
{
public:
    UE_CLASS("/Game/LevelElements/Minehead/ABP_Minehead", "ABP_Minehead_C");
    ...
    void ExecuteUbergraph_ABP_Minehead(int EntryPoint);
...
using ABP_Minehead_C = Game::LevelElements::Minehead::ABP_Minehead_C;