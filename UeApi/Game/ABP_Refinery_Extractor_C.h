#pragma once
/*
Blueprint class ABP_Refinery_Extractor_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Refinery_Extractor_C : public UPipelineExtractorPodAnimInstance
{
public:
    UE_CLASS("/Game/LevelElements/Refinery/Extractor/ABP_Refinery_Extractor", "ABP_Refinery_Extractor_C");
    ...
    void ExecuteUbergraph_ABP_Refinery_Extractor(int EntryPoint);
...
using ABP_Refinery_Extractor_C = Game::LevelElements::Refinery::Extractor::ABP_Refinery_Extractor_C;