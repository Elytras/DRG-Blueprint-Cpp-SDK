#pragma once
/*
Blueprint class ABP_Spider_Locomotion_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Spider_Locomotion_C : public USpiderAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/Spider/ABP_Spider_Locomotion", "ABP_Spider_Locomotion_C");
    ...
    void ExecuteUbergraph_ABP_Spider_Locomotion(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}   // namespace Game::Enemies::Spider

using ABP_Spider_Locomotion_C = Game::Enemies::Spider::ABP_Spider_Locomotion_C;