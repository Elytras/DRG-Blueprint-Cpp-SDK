#pragma once
/*
Blueprint class ABP_Spider_Shooting_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Spider_Shooting_C : public UShootingSpiderAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/Spider/ABP_Spider_Shooting", "ABP_Spider_Shooting_C");
    ...
    void ExecuteUbergraph_ABP_Spider_Shooting(int EntryPoint);
...
using ABP_Spider_Shooting_C = Game::Enemies::Spider::ABP_Spider_Shooting_C;