#pragma once
/*
Blueprint class ABP_Spider_Swarmer_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Spider_Swarmer_C : public USpiderAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/Spider/Swarmer/ABP_Spider_Swarmer", "ABP_Spider_Swarmer_C");
    ...
    void ExecuteUbergraph_ABP_Spider_Swarmer(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}}   // namespace Game::Enemies::Spider::Swarmer

using ABP_Spider_Swarmer_C = Game::Enemies::Spider::Swarmer::ABP_Spider_Swarmer_C;