#pragma once
/*
Blueprint class ABP_Tentacle_Head_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_Tentacle_Head_C : public UFacilityTentacleHeadAnimInstance
{
public:
    UE_CLASS("/Game/GameElements/Objectives/Facility/DefensiveTentacles/ABP_Tentacle_Head", "ABP_Tentacle_Head_C");
    ...
    void ExecuteUbergraph_ABP_Tentacle_Head(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}}}   // namespace Game::GameElements::Objectives::Facility::DefensiveTentacles

using ABP_Tentacle_Head_C = Game::GameElements::Objectives::Facility::DefensiveTentacles::ABP_Tentacle_Head_C;