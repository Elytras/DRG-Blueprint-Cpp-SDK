#pragma once
/*
Blueprint class ABP_WoodlouseNew_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ABP_WoodlouseNew_C : public UWoodLouseAnimInstance
{
public:
    UE_CLASS("/Game/Enemies/Woodlouse/ABP_WoodlouseNew", "ABP_WoodlouseNew_C");
    ...
    void ExecuteUbergraph_ABP_WoodlouseNew(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}   // namespace Game::Enemies::Woodlouse

using ABP_WoodlouseNew_C = Game::Enemies::Woodlouse::ABP_WoodlouseNew_C;