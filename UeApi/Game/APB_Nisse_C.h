#pragma once
/*
Blueprint class APB_Nisse_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class APB_Nisse_C : public UNisseAnimInstance
{
public:
    UE_CLASS("/Game/GameElements/Holidays/Xmas/Nisse/APB_Nisse", "APB_Nisse_C");
    ...
    void ExecuteUbergraph_APB_Nisse(int EntryPoint);
    void AnimGraph(FPoseLink& AnimGraph_0);
};

}}}}}   // namespace Game::GameElements::Holidays::Xmas::Nisse

using APB_Nisse_C = Game::GameElements::Holidays::Xmas::Nisse::APB_Nisse_C;