#pragma once
/*
Blueprint class BP_Anniversary_Trophy8_InCave_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
namespace Game { namespace GameElements { namespace Holidays { namespace Anniversary {

class BP_Anniversary_Trophy8_InCave_C : public AGem
{
public:
    ...
    static constexpr const char* StaticMesh__UeScsNode = "70fdbe592f149240a9fdd22adfe77ae6";
    ...
    void ExecuteUbergraph_BP_Anniversary_Trophy8_InCave(int EntryPoint);
...
}}}}   // namespace Game::GameElements::Holidays::Anniversary

using BP_Anniversary_Trophy8_InCave_C = Game::GameElements::Holidays::Anniversary::BP_Anniversary_Trophy8_InCave_C;