#pragma once
/*
Blueprint class BP_Arch_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_Arch_C : public AActor
{
public:
    UE_CLASS("/Game/Landscape/Biomes/Biomes_Ingame/BoneYards/Carvers/BP_Arch", "BP_Arch_C");
...
using BP_Arch_C = Game::Landscape::Biomes::Biomes_Ingame::BoneYards::Carvers::BP_Arch_C;