#pragma once
/*
Blueprint class BP_Armor_Scout_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_Armor_Scout_C : public AArmorPiece
{
public:
...
using BP_Armor_Scout_C = Game::WeaponsNTools::Armor::BP_Armor_Scout_C;