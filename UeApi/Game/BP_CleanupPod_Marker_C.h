#pragma once
/*
Blueprint class BP_CleanupPod_Marker_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_CleanupPod_Marker_C : public AItemMarker
{
public:
    ...
    FName ColorName;
    void ExecuteUbergraph_BP_CleanupPod_Marker(int EntryPoint);
...
using BP_CleanupPod_Marker_C = Game::GameElements::Missions::Warnings::Plague::CleaningPod::BP_CleanupPod_Marker_C;