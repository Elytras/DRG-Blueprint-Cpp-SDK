#pragma once
/*
Blueprint class BP_Crawler_Puddle_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_Crawler_Puddle_C : public AAdicPuddle
{
public:
    ...
    void ExecuteUbergraph_BP_Crawler_Puddle(int EntryPoint);
    void FadeOut();
    void ResetTimer();
...
using BP_Crawler_Puddle_C = Game::Enemies::Crawler::BP_Crawler_Puddle_C;