#pragma once
/*
Blueprint class BP_Lunar2026_HorseStatue_InCave_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
namespace Game { namespace GameElements { namespace Holidays { namespace Lunar_NewYear {

class BP_Lunar2026_HorseStatue_InCave_C : public AGem
{
public:
    UE_CLASS("/Game/GameElements/Holidays/Lunar_NewYear/BP_Lunar2026_HorseStatue_InCave", "BP_Lunar2026_HorseStatue_InCave_C");
    ...
    void ExecuteUbergraph_BP_Lunar2026_HorseStatue_InCave(int EntryPoint);
...
using BP_Lunar2026_HorseStatue_InCave_C = Game::GameElements::Holidays::Lunar_NewYear::BP_Lunar2026_HorseStatue_InCave_C;