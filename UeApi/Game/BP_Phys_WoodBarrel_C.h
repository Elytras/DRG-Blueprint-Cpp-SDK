#pragma once
/*
Blueprint class BP_Phys_WoodBarrel_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_Phys_WoodBarrel_C : public AFSDPhysicsActor
{
public:
    UE_CLASS("/Game/Art/Environments/Holiday_Oktoberfest/BP_Phys_WoodBarrel", "BP_Phys_WoodBarrel_C");
    ...
    void ExecuteUbergraph_BP_Phys_WoodBarrel(int EntryPoint);
...
using BP_Phys_WoodBarrel_C = Game::Art::Environments::Holiday_Oktoberfest::BP_Phys_WoodBarrel_C;