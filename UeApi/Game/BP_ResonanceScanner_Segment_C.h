#pragma once
/*
Blueprint class BP_ResonanceScanner_Segment_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_ResonanceScanner_Segment_C : public AFuelLineSegment
{
public:
    UE_CLASS("/Game/GameElements/Objectives/DeepScan/BP_ResonanceScanner_Segment", "BP_ResonanceScanner_Segment_C");
    ...
    FVector EndLocation;
    void ExecuteUbergraph_BP_ResonanceScanner_Segment(int EntryPoint);
...
using BP_ResonanceScanner_Segment_C = Game::GameElements::Objectives::DeepScan::BP_ResonanceScanner_Segment_C;