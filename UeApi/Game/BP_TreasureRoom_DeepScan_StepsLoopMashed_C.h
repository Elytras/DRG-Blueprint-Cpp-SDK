#pragma once
/*
Blueprint class BP_TreasureRoom_DeepScan_StepsLoopMashed_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_TreasureRoom_DeepScan_StepsLoopMashed_C : public Game::GameElements::Objectives::DeepScan::TreasureRooms::BP_TreasureRoom_DeepScan_Base_C
{
public:
    UE_CLASS("/Game/GameElements/Objectives/DeepScan/TreasureRooms/BP_TreasureRoom_DeepScan_StepsLoopMashed", "BP_TreasureRoom_DeepScan_StepsLoopMashed_C");
...
using BP_TreasureRoom_DeepScan_StepsLoopMashed_C = Game::GameElements::Objectives::DeepScan::TreasureRooms::BP_TreasureRoom_DeepScan_StepsLoopMashed_C;