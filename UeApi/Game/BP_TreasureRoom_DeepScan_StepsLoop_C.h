#pragma once
/*
Blueprint class BP_TreasureRoom_DeepScan_StepsLoop_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class BP_TreasureRoom_DeepScan_StepsLoop_C : public Game::GameElements::Objectives::DeepScan::TreasureRooms::BP_TreasureRoom_DeepScan_Base_C
{
public:
    UE_CLASS("/Game/GameElements/Objectives/DeepScan/TreasureRooms/BP_TreasureRoom_DeepScan_StepsLoop", "BP_TreasureRoom_DeepScan_StepsLoop_C");
...
using BP_TreasureRoom_DeepScan_StepsLoop_C = Game::GameElements::Objectives::DeepScan::TreasureRooms::BP_TreasureRoom_DeepScan_StepsLoop_C;