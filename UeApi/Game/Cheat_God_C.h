#pragma once
/*
Blueprint class Cheat_God_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class Cheat_God_C : public UUserWidget
{
public:
    UE_CLASS("/Game/UI/Menu_Cheats/Cheat_God", "Cheat_God_C");
