#pragma once
/*
Blueprint class Cheat_KillAll_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class Cheat_KillAll_C : public UUserWidget
{
public:
    UE_CLASS("/Game/UI/Menu_Cheats/Cheat_KillAll", "Cheat_KillAll_C");
    ...
    void ExecuteUbergraph_Cheat_KillAll(int EntryPoint);
