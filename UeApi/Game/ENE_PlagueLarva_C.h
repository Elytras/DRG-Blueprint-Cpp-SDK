#pragma once
/*
Blueprint class ENE_PlagueLarva_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ENE_PlagueLarva_C : public AEnemyDeepPathfinderCharacter
{
public:
    ...
    void ExecuteUbergraph_ENE_PlagueLarva(int EntryPoint);
...
using ENE_PlagueLarva_C = Game::Enemies::Plague::PlagueLarva::ENE_PlagueLarva_C;