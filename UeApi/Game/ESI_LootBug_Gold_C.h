#pragma once
/*
Blueprint class ESI_LootBug_Gold_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ESI_LootBug_Gold_C : public AEnemyShowroomItem
{
public:
...
using ESI_LootBug_Gold_C = Game::Critters::LootBug::ESI_LootBug_Gold_C;