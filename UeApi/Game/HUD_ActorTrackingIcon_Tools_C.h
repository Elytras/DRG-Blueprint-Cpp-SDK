#pragma once
/*
Blueprint class HUD_ActorTrackingIcon_Tools_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class HUD_ActorTrackingIcon_Tools_C : public UActorTrackingWidget
{
public:
    UE_CLASS("/Game/UI/MainOnscreenHUD/HUD_ActorTrackingIcon_Tools", "HUD_ActorTrackingIcon_Tools_C");
    ...
    float ArrowRadius;
    float ArrowAngle;
    void ExecuteUbergraph_HUD_ActorTrackingIcon_Tools(int EntryPoint);
    void OnShow();
...
using HUD_ActorTrackingIcon_Tools_C = Game::UI::MainOnscreenHUD::HUD_ActorTrackingIcon_Tools_C;