#pragma once
/*
Blueprint class ITM_DeepDives_LaunchButton_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ITM_DeepDives_LaunchButton_C : public UUserWidget
{
public:
    UE_CLASS("/Game/UI/Menu_DeepDives/ITM_DeepDives_LaunchButton", "ITM_DeepDives_LaunchButton_C");
    ...
    void ExecuteUbergraph_ITM_DeepDives_LaunchButton(int EntryPoint);
    void Click();
