#pragma once
/*
Blueprint class ITM_Season05EventBonus_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ITM_Season05EventBonus_C : public UUserWidget
{
public:
    UE_CLASS("/Game/UI/Menu_Seasons/ITM_Season05EventBonus", "ITM_Season05EventBonus_C");
    ...
    void ExecuteUbergraph_ITM_Season05EventBonus(int EntryPoint);
...
using ITM_Season05EventBonus_C = Game::UI::Menu_Seasons::ITM_Season05EventBonus_C;