#pragma once
/*
Blueprint class LoreScreen_MissionType_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class LoreScreen_MissionType_C : public Game::UI::Menu_MinersManual::InfoScreens::LoreScreen_Master_C
{
public:
    UE_CLASS("/Game/UI/Menu_MinersManual/InfoScreens/LoreScreen_MissionType", "LoreScreen_MissionType_C");
    ...
    int NumberPerRow;
    int NumberOnCurrRow;
    void ExecuteUbergraph_LoreScreen_MissionType(int EntryPoint);
...
using LoreScreen_MissionType_C = Game::UI::Menu_MinersManual::InfoScreens::LoreScreen_MissionType_C;