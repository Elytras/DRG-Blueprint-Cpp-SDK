#pragma once
/*
Blueprint class Menu_MovieMode_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
namespace Game { namespace GameElements { namespace MovieMode { namespace UI { class MovieMode_DronePointLight_C; class MovieMode_FlareLight_C; class MovieMode_ScoutFlareLight_C; }}}}

namespace Game { namespace GameElements { namespace MovieMode { namespace UI {

class Menu_MovieMode_C : public UWindowWidget
{
public:
    UE_CLASS("/Game/GameElements/MovieMode/UI/Menu_MovieMode", "Menu_MovieMode_C");
    using MovieMode_DronePointLight_C = Game::GameElements::MovieMode::UI::MovieMode_DronePointLight_C;
    using MovieMode_FlareLight_C = Game::GameElements::MovieMode::UI::MovieMode_FlareLight_C;
    ...
    MovieMode_DronePointLight_C* MovieMode_DronePointLight;
    MovieMode_FlareLight_C* MovieMode_FlareLight;
    MovieMode_ScoutFlareLight_C* MovieMode_ScoutFlareLight;
    ...
    void SelectTab(int Index_0, class UButton* Tab_Button);
    void DeselectTab(class UButton* Active_Tab);
    void SetOnOffTexts(bool Condition, class UTextBlock* OffText_0, class UTextBlock* OnText_0);
};

}}}}   // namespace Game::GameElements::MovieMode::UI

using Menu_MovieMode_C = Game::GameElements::MovieMode::UI::Menu_MovieMode_C;