#pragma once
/*
Blueprint class MovieMode_FlareLight_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class MovieMode_FlareLight_C : public UUserWidget
{
public:
    UE_CLASS("/Game/GameElements/MovieMode/UI/MovieMode_FlareLight", "MovieMode_FlareLight_C");
    ...
    void ExecuteUbergraph_MovieMode_FlareLight(int EntryPoint);
    void Rebuild();
