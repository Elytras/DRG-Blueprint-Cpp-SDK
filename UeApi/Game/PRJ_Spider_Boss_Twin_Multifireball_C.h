#pragma once
/*
Blueprint class PRJ_Spider_Boss_Twin_Multifireball_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class PRJ_Spider_Boss_Twin_Multifireball_C : public AProjectile
{
public:
    UE_CLASS("/Game/Enemies/Spider/TankBoss/BossTwins/PRJ_Spider_Boss_Twin_Multifireball", "PRJ_Spider_Boss_Twin_Multifireball_C");
    ...
    void ExecuteUbergraph_PRJ_Spider_Boss_Twin_Multifireball(int EntryPoint);
...
using PRJ_Spider_Boss_Twin_Multifireball_C = Game::Enemies::Spider::TankBoss::BossTwins::PRJ_Spider_Boss_Twin_Multifireball_C;