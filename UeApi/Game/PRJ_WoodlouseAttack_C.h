#pragma once
/*
Blueprint class PRJ_WoodlouseAttack_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class PRJ_WoodlouseAttack_C : public AProjectile
{
public:
    UE_CLASS("/Game/Enemies/Woodlouse/PRJ_WoodlouseAttack", "PRJ_WoodlouseAttack_C");
    ...
    void ExecuteUbergraph_PRJ_WoodlouseAttack(int EntryPoint);
...
using PRJ_WoodlouseAttack_C = Game::Enemies::Woodlouse::PRJ_WoodlouseAttack_C;