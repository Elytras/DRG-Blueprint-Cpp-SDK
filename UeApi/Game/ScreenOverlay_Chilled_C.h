#pragma once
/*
Blueprint class ScreenOverlay_Chilled_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_Chilled_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_Chilled", "ScreenOverlay_Chilled_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_Chilled(int EntryPoint);
...
using ScreenOverlay_Chilled_C = Game::UI::ScreenOverlays::ScreenOverlay_Chilled_C;