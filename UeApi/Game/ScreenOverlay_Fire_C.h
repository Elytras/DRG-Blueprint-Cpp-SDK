#pragma once
/*
Blueprint class ScreenOverlay_Fire_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_Fire_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_Fire", "ScreenOverlay_Fire_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_Fire(int EntryPoint);
...
using ScreenOverlay_Fire_C = Game::UI::ScreenOverlays::ScreenOverlay_Fire_C;