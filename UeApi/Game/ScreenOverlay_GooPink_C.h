#pragma once
/*
Blueprint class ScreenOverlay_GooPink_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_GooPink_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_GooPink", "ScreenOverlay_GooPink_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_GooPink(int EntryPoint);
...
using ScreenOverlay_GooPink_C = Game::UI::ScreenOverlays::ScreenOverlay_GooPink_C;