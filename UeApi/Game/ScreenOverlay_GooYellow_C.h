#pragma once
/*
Blueprint class ScreenOverlay_GooYellow_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_GooYellow_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_GooYellow", "ScreenOverlay_GooYellow_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_GooYellow(int EntryPoint);
...
using ScreenOverlay_GooYellow_C = Game::UI::ScreenOverlays::ScreenOverlay_GooYellow_C;