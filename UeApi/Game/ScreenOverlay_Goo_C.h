#pragma once
/*
Blueprint class ScreenOverlay_Goo_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_Goo_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_Goo", "ScreenOverlay_Goo_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_Goo(int EntryPoint);
...
using ScreenOverlay_Goo_C = Game::UI::ScreenOverlays::ScreenOverlay_Goo_C;