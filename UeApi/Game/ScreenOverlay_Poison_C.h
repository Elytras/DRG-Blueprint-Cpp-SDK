#pragma once
/*
Blueprint class ScreenOverlay_Poison_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_Poison_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_Poison", "ScreenOverlay_Poison_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_Poison(int EntryPoint);
...
using ScreenOverlay_Poison_C = Game::UI::ScreenOverlays::ScreenOverlay_Poison_C;