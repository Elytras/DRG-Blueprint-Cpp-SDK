#pragma once
/*
Blueprint class ScreenOverlay_Webbed_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class ScreenOverlay_Webbed_C : public UPlayerAfflictionOverlayWidget
{
public:
    UE_CLASS("/Game/UI/ScreenOverlays/ScreenOverlay_Webbed", "ScreenOverlay_Webbed_C");
    ...
    float FadeDuration;
    void ExecuteUbergraph_ScreenOverlay_Webbed(int EntryPoint);
...
using ScreenOverlay_Webbed_C = Game::UI::ScreenOverlays::ScreenOverlay_Webbed_C;