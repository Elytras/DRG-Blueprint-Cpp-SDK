#pragma once
/*
Blueprint class UI_InfoScreen_SeasonDLC_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class UI_InfoScreen_SeasonDLC_C : public UUserWidget
{
public:
    UE_CLASS("/Game/UI/Menu_StartScreen/UI_InfoScreen_SeasonDLC", "UI_InfoScreen_SeasonDLC_C");
    ...
    class UGameDLC* DLC;
    void ExecuteUbergraph_UI_InfoScreen_SeasonDLC(int EntryPoint);
