#pragma once
/*
Blueprint class UI_RewardUnlock_Vanity_C, generated by AssetGen/tools/genueapi.py. Do not edit.
...
class UI_RewardUnlock_Vanity_C : public URewardWidget
{
public:
    UE_CLASS("/Game/UI/HUD_SpaceRig/CampaignNotifications/UI_RewardUnlock_Vanity", "UI_RewardUnlock_Vanity_C");
    ...
    void ExecuteUbergraph_UI_RewardUnlock_Vanity(int EntryPoint);
...
using UI_RewardUnlock_Vanity_C = Game::UI::HUD_SpaceRig::CampaignNotifications::UI_RewardUnlock_Vanity_C;