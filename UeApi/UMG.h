...
public:
    ...
    UE_COSMETIC void OnDragCancelled(FPointerEvent PointerEvent, class UDragDropOperation* Operation);
    UE_COSMETIC void OnDragDetected(FGeometry MyGeometry, FPointerEvent PointerEvent, class UDragDropOperation*& Operation);
    ...
    UE_COSMETIC FEventReply OnMouseButtonDoubleClick(FGeometry InMyGeometry, FPointerEvent InMouseEvent);
    ...
    UE_COSMETIC FEventReply OnPreviewMouseButtonDown(FGeometry MyGeometry, FPointerEvent MouseEvent);
    UE_COSMETIC void OnRemovedFromFocusPath(FFocusEvent InFocusEvent);
    UE_COSMETIC FEventReply OnTouchEnded(FGeometry MyGeometry, FPointerEvent InTouchEvent);
    UE_COSMETIC FEventReply OnTouchForceChanged(FGeometry MyGeometry, FPointerEvent InTouchEvent);
    UE_COSMETIC FEventReply OnTouchGesture(FGeometry MyGeometry, FPointerEvent GestureEvent);
    UE_COSMETIC FEventReply OnTouchMoved(FGeometry MyGeometry, FPointerEvent InTouchEvent);
    UE_COSMETIC FEventReply OnTouchStarted(FGeometry MyGeometry, FPointerEvent InTouchEvent);
...
public:
    ...
    UE_PURE static FVector2D AbsoluteToLocal(FGeometry Geometry, FVector2D AbsoluteCoordinate);
    ...
    UE_PURE static bool EqualEqual_SlateBrush(FSlateBrush A, FSlateBrush B);
    UE_PURE static FVector2D GetAbsoluteSize(FGeometry Geometry);
    UE_PURE static FVector2D GetLocalSize(FGeometry Geometry);
    UE_PURE static FVector2D GetLocalTopLeft(FGeometry Geometry);
    UE_PURE static bool IsUnderLocation(FGeometry Geometry, FVector2D AbsoluteCoordinate);
    UE_PURE static FVector2D LocalToAbsolute(FGeometry Geometry, FVector2D LocalCoordinate);
    static void LocalToViewport(class UObject* WorldContextObject, FGeometry Geometry, FVector2D LocalCoordinate, FVector2D& PixelPosition, FVector2D& ViewportPosition);
    static void LocalToViewport(FGeometry Geometry, FVector2D LocalCoordinate, FVector2D& PixelPosition, FVector2D& ViewportPosition);
    ...
    static void ScreenToWidgetLocal(class UObject* WorldContextObject, FGeometry Geometry, FVector2D ScreenPosition, FVector2D& LocalCoordinate, bool bIncludeWindowPosition);
    static void ScreenToWidgetLocal(FGeometry Geometry, FVector2D ScreenPosition, FVector2D& LocalCoordinate, bool bIncludeWindowPosition);
    UE_PURE static float TransformScalarAbsoluteToLocal(FGeometry Geometry, float AbsoluteScalar);
    UE_PURE static float TransformScalarLocalToAbsolute(FGeometry Geometry, float LocalScalar);
    UE_PURE static FVector2D TransformVectorAbsoluteToLocal(FGeometry Geometry, FVector2D AbsoluteVector);
    UE_PURE static FVector2D TransformVectorLocalToAbsolute(FGeometry Geometry, FVector2D LocalVector);
};
...
public:
    ...
    UE_PURE static class UObject* GetBrushResource(FSlateBrush Brush);
    ...
    UE_PURE static FInputEvent GetInputEventFromPointerEvent(FPointerEvent Event);
    UE_PURE static FKeyEvent GetKeyEventFromAnalogInputEvent(FAnalogInputEvent Event);
